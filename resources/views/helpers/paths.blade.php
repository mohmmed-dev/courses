    ...
    <div class="my-2 col-start-2 col-span-10 sm:col-start-0 sm:col-span-6 md:col-span-5 lg:col-span-3">
        <div class="carousel-item card w-96 h-52  bg-base-100 shadow-xl">
            <div class="rounded-md ">
                <a href="{{route('path.show',$path->slug)}}" class="hero h-52 rounded-md " style="background-image: url(https://img.daisyui.com/images/stock/photo-1507358522600-9f71e620c44e.webp);">
